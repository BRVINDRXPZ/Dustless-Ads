...
- Executive action plan with mission, objectives, initial hypothesis, 72-hour plan, 30-day roadmap, dependencies, risks, metric framework, execution order, and strict priority stack.
- Assumption and decision registers separating unverified working beliefs from durable instructions.
- Next-action queue with owner gates, dependencies, deliverables, and completion criteria.
- Organized workspaces for audits, research, strategy, acquisition, conversion, tracking, local SEO, content, relationship channels, operations, experimentation, and reporting.
